...
struct {
  ...
  { // Brickadia-Win64-Shipping
    &Brickadia,
    {"\x48\x8D\x0D\x00\x00\x00\x00\xE8\xAD\xB3\xFF\xFF\x4C\x8B\xC0\xC6\x05\xE7\x41\x98\x03\x01", 22},
    {"\x48\x8B\x05\x00\x00\x00\x00\x48\x8B\x0C\xC8\x48\x8D\x1C\xD1\xEB\x03", 17},
    nullptr
  },
...
std::unordered_map<std::string, decltype(&engines[0])> games = {
  ...
  {"ShooterGame-Win64-Shipping", &engines[3]},
